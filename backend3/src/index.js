...
const start = async () => {
  ...
  const connectWithRetry = async () => {
    ...
    try {
      ...
      console.log('[DATABASE] Connection string (masked):', mongoUri.replace(/:[^:]*@/, ':****@'));
      ...
      console.warn('[DATABASE] ⚠️  Atlas connection failed.');
      console.warn('[DATABASE] Error details:', err.message);
      console.warn('[DATABASE] Trying local MongoDB...');
      try {
        await mongoose.connect('mongodb://127.0.0.1:27017/alumni', { serverSelectionTimeoutMS: 5000 });
        ...
        console.error('[DATABASE] Atlas Error:', err.message);
        console.error('[DATABASE] Local Error:', localErr.message);
        ...
        console.log('   4. Try: mongosh "mongodb+srv://..." --username dolumakwana93_db_user');
