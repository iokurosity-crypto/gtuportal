...
router.post('/request', requireAuth, async (req, res) => {
  try {
    ...
    await connection.populate('fromUser', 'name email department batch profilePhoto profilePicture photoURL');
    await connection.populate('toUser', 'name email department batch profilePhoto profilePicture photoURL');
...
router.get('/incoming', requireAuth, async (req, res) => {
  try {
    ...
    const requests = await Connection.find({
      ...
      .populate('fromUser', 'name email profilePhoto profilePicture photoURL department batch currentJobTitle currentCompany')
      .sort({ createdAt: -1 });
...
router.get('/outgoing', requireAuth, async (req, res) => {
  try {
    ...
    const requests = await Connection.find({
      ...
      .populate('toUser', 'name email profilePhoto profilePicture photoURL department batch currentJobTitle currentCompany')
      .sort({ createdAt: -1 });
...
router.get('/', requireAuth, async (req, res) => {
  try {
    ...
    const connections = await Connection.find({
      ...
      .populate('fromUser', 'name email profilePhoto profilePicture photoURL currentJobTitle currentCompany department batch currentLocation')
      .populate('toUser', 'name email profilePhoto profilePicture photoURL currentJobTitle currentCompany department batch currentLocation')
      .sort({ updatedAt: -1 });
